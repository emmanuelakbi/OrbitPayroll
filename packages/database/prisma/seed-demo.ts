...
import { PrismaClient, Role, PayCycle, PayrollStatus, ItemStatus } from '@prisma/client';
...
async function main() {
  ...
  // Create demo contractors with realistic data
  ...
  const contractors = await Promise.all([
    prisma.contractor.create({
      data: {
        ...
        walletAddress: DEMO_ADDRESSES.contractors[0]!.toLowerCase(),
        rateAmount: new Decimal('8500.00000000'),
        rateCurrency: 'MNEE',
    ...
    prisma.contractor.create({
      data: {
        ...
        walletAddress: DEMO_ADDRESSES.contractors[1]!.toLowerCase(),
        rateAmount: new Decimal('6500.00000000'),
        rateCurrency: 'MNEE',
        payCycle: PayCycle.MONTHLY,
        active: true,
      },
    ...
    prisma.contractor.create({
      data: {
        ...
        walletAddress: DEMO_ADDRESSES.contractors[2]!.toLowerCase(),
        rateAmount: new Decimal('7500.00000000'),
        rateCurrency: 'MNEE',
    ...
    prisma.contractor.create({
      data: {
        ...
        walletAddress: DEMO_ADDRESSES.contractors[3]!.toLowerCase(),
        rateAmount: new Decimal('4500.00000000'),
        rateCurrency: 'MNEE',
        payCycle: PayCycle.BI_WEEKLY,
        active: true,
      },
    ...
    prisma.contractor.create({
      data: {
        ...
        walletAddress: DEMO_ADDRESSES.contractors[4]!.toLowerCase(),
  ...
  const decemberPayroll = await prisma.payrollRun.create({
    data: {
      ...
      txHash: '0xdec2025dec2025dec2025dec2025dec2025dec2025dec2025dec2025dec20251',
      totalMnee: new Decimal('30000.00000000'),
      status: PayrollStatus.EXECUTED,
      items: {
        create: [
          { contractorId: contractors[0].id, amountMnee: new Decimal('8500.00000000'), status: ItemStatus.PAID },
          { contractorId: contractors[1].id, amountMnee: new Decimal('6500.00000000'), status: ItemStatus.PAID },
          { contractorId: contractors[2].id, amountMnee: new Decimal('7500.00000000'), status: ItemStatus.PAID },
          { contractorId: contractors[3].id, amountMnee: new Decimal('4500.00000000'), status: ItemStatus.PAID },
          { contractorId: contractors[4].id, amountMnee: new Decimal('3000.00000000'), status: ItemStatus.PAID },
        ],
      },
    },
  });
  ...
  const januaryPayroll1 = await prisma.payrollRun.create({
    data: {
      ...
      txHash: '0xjan2026jan2026jan2026jan2026jan2026jan2026jan2026jan2026jan20261',
  ...
  const januaryPayroll2 = await prisma.payrollRun.create({
    data: {
      ...
      txHash: '0xjan2026jan2026jan2026jan2026jan2026jan2026jan2026jan2026jan20262',
  ...
  const februaryPayroll = await prisma.payrollRun.create({
    data: {
      ...
      items: {
        create: [
          { contractorId: contractors[0].id, amountMnee: new Decimal('8500.00000000'), status: ItemStatus.PENDING },
          { contractorId: contractors[1].id, amountMnee: new Decimal('6500.00000000'), status: ItemStatus.PENDING },
          { contractorId: contractors[2].id, amountMnee: new Decimal('7500.00000000'), status: ItemStatus.PENDING },
          { contractorId: contractors[3].id, amountMnee: new Decimal('4500.00000000'), status: ItemStatus.PENDING },
          { contractorId: contractors[4].id, amountMnee: new Decimal('3000.00000000'), status: ItemStatus.PENDING },
        ],
      },
    },
  });
    ...
    data: [
      {
        ...
        payload: { orgName: 'Orbit Demo Corp', treasuryAddress: DEMO_ADDRESSES.treasury },
      ...
      },
      {
        ...
        payload: { memberEmail: 'finance@orbitpayroll.demo', role: 'FINANCE_OPERATOR' },
      ...
      })),
      {
        ...
        payload: { runId: decemberPayroll.id, runLabel: 'December 2025 Monthly Payroll', totalMnee: '30000.00000000' },
      ...
      },
      {
        ...
        userId: demoAdmin.id,
        eventType: 'PAYROLL_EXECUTED',
        payload: { runId: januaryPayroll1.id, runLabel: 'January 2026 Bi-Weekly Payroll #1', totalMnee: '15000.00000000' },
      ...
      },
      {
        ...
        userId: financeOperator.id,
        eventType: 'PAYROLL_EXECUTED',
        payload: { runId: januaryPayroll2.id, runLabel: 'January 2026 Bi-Weekly Payroll #2', totalMnee: '12000.00000000' },
      ...
      },
      {
        ...
        payload: { runId: februaryPayroll.id, runLabel: 'February 2026 Monthly Payroll', scheduledDate: '2026-02-01' },
    ...
    data: [
      {
        ...
        message: 'December 2025 payroll has been executed successfully. Total: 30,000 MNEE distributed to 5 contractors.',
        read: true,
        createdAt: new Date('2025-12-01T14:30:00Z'),
      },
      {
        ...
        message: 'January 2026 bi-weekly payroll #1 has been executed. Total: 15,000 MNEE.',
        read: true,
        createdAt: new Date('2026-01-01T10:15:00Z'),
      },
      {
        ...
        message: 'January 2026 bi-weekly payroll #2 has been executed. Total: 12,000 MNEE.',
        read: false,
        createdAt: new Date('2026-01-15T09:45:00Z'),
      },
      {
        ...
        message: 'February 2026 monthly payroll is scheduled for Feb 1, 2026. Total: 30,000 MNEE.',
        read: false,
        createdAt: new Date('2026-01-10T16:00:00Z'),
      },
      {
        ...
        message: 'Your treasury balance is running low. Consider depositing more MNEE before the next payroll.',
        read: false,
      ...
      },
      {
        ...
        message: 'You have been added as a Finance Operator. You can now preview and execute payroll runs.',
        read: true,
        createdAt: new Date('2025-11-15T10:05:00Z'),
      },
    ],
